...
INSERT INTO "new_TextBlock" ("content", "end", "id", "isHighlighted", "isModified", "previewId", "recordId", "reliability", "start") SELECT "content", "end", "id", "isHighlighted", "isModified", "previewId", "recordId", "reliability", "start" FROM "TextBlock";

...
var translations = {
  ...
  kr: {
    uploading: "업로드 중...",
    uploadingItem: "1개의 항목 업로드중",
    uploadingItems: "{quantity}개의 항목 업로드중",
    upload: "업로드",
    remove: "삭제",
    download: "다운로드",
    rename: "이름 바꾸기",
    creating: "생성중",
    creatingName: "{name}을 생성중입니다...",
    create: "만들기",
    createFolder: "폴더 만들기",
    zipping: "압축 중",
    zippingItem: "1개의 항목 압축 중",
    zippingItems: "{quantity}개의 항목 압축중",
    items: "항목들",
    item: "항목",
    cancel: "취소",
    confirm: "확인",
    folderName: "폴더 이름",
    files: "파일들",
    fileExist: "'{name}'이라는 이름의 파일/폴더가 이미 존재합니다.",
    newName: "새 이름",
    emptyName: "이름은 공백일 수 없습니다.",
    tooLongFolderName: "폴더 이름은 255자를 초과할 수 없습니다.",
    folderNameNotAllowedCharacters:
...
function getMessage(locale, key, params) {
  ...
  var translation = translationExists
